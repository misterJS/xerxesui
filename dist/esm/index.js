...
var ContainerStyle = {"container":"Container-module_container__tr3IO","mobile":"Container-module_mobile__5dqJc","tablet":"Container-module_tablet__m9gXd","pc":"Container-module_pc__Sx-ym","superpc":"Container-module_superpc__ogw-P"};

var additionalWrapperStyles = function (rest) {
    var color = rest.color, fontSize = rest.fontSize, fontWeight = rest.fontWeight, fontStyle = rest.fontStyle, fontFamily = rest.fontFamily, textDecoration = rest.textDecoration, textTransform = rest.textTransform, textAlign = rest.textAlign, lineHeight = rest.lineHeight, letterSpacing = rest.letterSpacing, wordSpacing = rest.wordSpacing, whiteSpace = rest.whiteSpace, backgroundColor = rest.backgroundColor, backgroundImage = rest.backgroundImage, backgroundSize = rest.backgroundSize, backgroundPosition = rest.backgroundPosition, backgroundRepeat = rest.backgroundRepeat, border = rest.border, borderTop = rest.borderTop, borderRight = rest.borderRight, borderBottom = rest.borderBottom, borderLeft = rest.borderLeft, borderColor = rest.borderColor, borderRadius = rest.borderRadius, boxShadow = rest.boxShadow, opacity = rest.opacity, zIndex = rest.zIndex, width = rest.width, minWidth = rest.minWidth, maxWidth = rest.maxWidth, height = rest.height, minHeight = rest.minHeight, maxHeight = rest.maxHeight, margin = rest.margin, marginTop = rest.marginTop, marginRight = rest.marginRight, marginBottom = rest.marginBottom, marginLeft = rest.marginLeft, padding = rest.padding, paddingTop = rest.paddingTop, paddingRight = rest.paddingRight, paddingBottom = rest.paddingBottom, paddingLeft = rest.paddingLeft, display = rest.display, position = rest.position, top = rest.top, right = rest.right, bottom = rest.bottom, left = rest.left, float = rest.float, clear = rest.clear, overflow = rest.overflow, cursor = rest.cursor, listStyle = rest.listStyle, pointerEvents = rest.pointerEvents, userSelect = rest.userSelect;
    return {
        color: color,
        fontSize: fontSize,
